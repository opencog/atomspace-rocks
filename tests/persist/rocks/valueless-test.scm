...
(define (test-valueless)
	...
	(cog-set-atomspace! base-space)
	(test-assert "yes-even-0" (cog-atom? (cog-node 'Concept "even")))
	(test-assert "no-odd-0" (not (cog-node 'Concept "odd")))
	(test-equal "even-0 as" base-space (cog-atomspace (cog-node 'Concept "even")))

	(cog-set-atomspace! mid1-space)
	(test-assert "yes-even-1" (cog-atom? (cog-node 'Concept "even")))
	(test-assert "yes-odd-1" (cog-atom? (cog-node 'Concept "odd")))
	...
	(cog-set-atomspace! mid2-space)
	(test-assert "no-even-2" (not (cog-node 'Concept "even")))
	(test-assert "yes-odd-2" (cog-atom? (cog-node 'Concept "odd")))
	(test-equal "odd-2 as" mid1-space (cog-atomspace (cog-node 'Concept "odd")))

	(cog-set-atomspace! mid3-space)
	(test-assert "no-even-3" (not (cog-node 'Concept "even")))
	(test-assert "no-odd-3" (not (cog-node 'Concept "odd")))

	(cog-set-atomspace! mid4-space)
	(test-assert "yes-even-4" (cog-atom? (cog-node 'Concept "even")))
	(test-assert "no-odd-4" (not (cog-node 'Concept "odd")))
	(test-equal "even-4 as" mid4-space (cog-atomspace (cog-node 'Concept "even")))

	(cog-set-atomspace! mid5-space)
	(test-assert "yes-even-5" (cog-atom? (cog-node 'Concept "even")))
	(test-assert "yes-odd-5" (cog-atom? (cog-node 'Concept "odd")))
	...
	(cog-set-atomspace! top-space)
	(test-assert "yes-even-6" (cog-atom? (cog-node 'Concept "even")))
	(test-assert "yes-odd-6" (cog-atom? (cog-node 'Concept "odd")))
